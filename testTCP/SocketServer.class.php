<?php
	...
	class SocketServer
	{
		...
		public function __construct($bind_ip,$port)
		{
			...
			$this->master_socket = socket_create(AF_INET, SOCK_STREAM, getprotobyname('tcp'));
			socket_bind($this->master_socket,$this->config["ip"],$this->config["port"]) or die("Issue Binding");
			socket_getsockname($this->master_socket,$bind_ip,$port) or die ("Issue socket_getsockname");
			socket_listen($this->master_socket,1000) or die("Issue socket_listen");
		...
		*/
		public function loop_once()
		{
			...
			$sock = socket_select($read,$write = NULL, $except = NULL, 5) or die ("Issue socket_select");
